...
class Trajectories:
    def __init__(self, states=None, rewards=None, returns=None, not_dones=None,
                 ...
                 unrolled=False, values=None, action_means=None, action_std=None, next_states=None):
    ...
    def tensor_op(self, lam, should_wrap=True):
        ...
        tt = op(self.states, self.rewards, self.returns, self.not_dones, self.next_states)
        ...
        ts = Trajectories(states=tt[0], rewards=tt[1], returns=tt[2],
                          ...
                          values=values, unrolled=True, next_states=tt[4])
