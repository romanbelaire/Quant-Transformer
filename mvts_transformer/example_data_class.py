class MarketData(BaseData):
    ...
    def __init__(self, root_dir, file_list=None, pattern=None, n_proc=1, limit_size=None, config=None):
        ...
        self.all_df = self.all_df.sort_values(by=['Date'])  # datasets is presorted
        self.all_df = self.all_df.set_index('Date')
    ...
    def load_all(self, root_dir, file_list=None, pattern=None):
        ...
        if self.n_proc > 1:
            ...
            all_df = pd.concat(MarketData.load_single(path) for path in input_paths)
